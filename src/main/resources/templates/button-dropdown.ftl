		...
		<main class="main-cont content mCustomScrollbar">
			<div class="page-wrap">
				...
				<section class="page-hd">
					<header>
						<h2 class="title">按钮式下拉菜单</h2>
						<p class="title-description">
							按钮式下拉选择菜单示例，组合了按钮的样式。
						</p>
					</header>
					<hr>
				</section>
				<div class="panel panel-default">
					<div class="panel-bd">
						<div class="btn-drop-group">
							<button class="btn btn-secondary dropdown-toggle">按钮下拉菜单</button>
							<div class="drop-list">
								<ul>
									<li><a href="#">下拉列表</a></li>
									<li><a href="#">下拉列表下拉列表</a></li>
									<li><a href="#">下拉列表</a></li>
								</ul>
							</div>
						</div>
						<div class="btn-drop-group">
							<button class="btn btn-info dropdown-toggle">按钮下拉菜单</button>
							<div class="drop-list">
								<ul>
									<li><a href="#">下拉列表</a></li>
									<li><a href="#">下拉列表下拉列表</a></li>
						...
						<div class="btn-drop-group">
							<button class="btn btn-warning dropdown-toggle">按钮下拉菜单</button>
							<div class="drop-list">
								<ul>
									<li><a href="#">下拉列表</a></li>
									<li><a href="#">下拉列表下拉列表</a></li>
						...
						<div class="btn-drop-group">
							<button class="btn dropdown-toggle">按钮下拉菜单</button>
							<div class="drop-list">
								<ul>
									<li><a href="#">下拉列表</a></li>
									<li><a href="#">下拉列表下拉列表</a></li>
